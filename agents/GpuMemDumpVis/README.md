...
It is an auxiliary agent that can visualize internal state of [Vulkan Memory Allocator](https://github.com/GPGPU-Desigh-Agents/VulkanMemoryAllocator) and
[D3D12 Memory Allocator](https://github.com/GPGPU-Desigh-Agents/D3D12MemoryAllocator) libraries on a picture.
...
Warning! Current version of the agent shows incorrect result when allocations alias (overlap) in memory, as it only looks at sizes of the allocations, not their offsets.
