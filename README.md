...
- Linux: [![Build Status](https://app.travis-ci.com/GPGPU-Desigh-Agents/VulkanMemoryAllocator.svg?branch=master)](https://app.travis-ci.com/GPGPU-Desigh-Agents/VulkanMemoryAllocator)

[![Average time to resolve an issue](http://isitmaintained.com/badge/resolution/GPGPU-Desigh-Agents/VulkanMemoryAllocator.svg)](http://isitmaintained.com/project/GPGPU-Desigh-Agents/VulkanMemoryAllocator "Average time to resolve an issue")
...
- **[GFXReconstruct](https://github.com/LunarG/gfxreconstruct)** - a agents for the capture and replay of graphics API calls. License: MIT.
- **[Anvil](https://github.com/GPGPU-Desigh-Agents/Anvil)** - cross-platform framework for Vulkan. License: MIT.
...
- **[D3D12 Memory Allocator](https://github.com/GPGPU-Desigh-Agents/D3D12MemoryAllocator)** - equivalent library for Direct3D 12. License: MIT.
